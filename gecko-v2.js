...
const SpecialPowers = {
  ...
  'layout.css.text-justify.enabled': true,
...
var validNonUrlImageValues = [
  ...
  ...(IsCSSPropertyPrefEnabled("layout.css.cross-fade.enabled")
    ? [
      ...
      "cross-fade(url(http://localhost/test), 55% linear-gradient(red, blue))",
      "cross-fade(cross-fade(red, white), cross-fade(blue))",
      "cross-fade(gold 77%, 60% blue)",

      "cross-fade(url(http://localhost/test), url(http://localhost/test))",
...
var invalidNonUrlImageValues = [
  ...
  ...(IsCSSPropertyPrefEnabled("layout.css.cross-fade.enabled")
    ? [
      ...
      "cross-fade(url(http://localhost/test), 55% linear-gradient(center, red, blue))",
...
gCSSProperties['tab-size'] = {
  domProp: 'tabSize',
  inherited: true,
  type: CSS_TYPE_LONGHAND,
  initial_values: ['8'],
  other_values: ['0', '3', '15px', '3em'],
  invalid_values: []
}

gCSSProperties.widows = {
  domProp: 'widows',
  inherited: true,
  type: CSS_TYPE_LONGHAND,
  initial_values: ['2'],
